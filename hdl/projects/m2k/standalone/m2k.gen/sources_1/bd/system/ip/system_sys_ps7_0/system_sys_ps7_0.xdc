...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_0 -period "36" [get_pins "PS7_i/FCLKCLK[0]"]
set_input_jitter clk_fpga_0 1.08
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_2 -period "10" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 0.3
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_3 -period "18" [get_pins "PS7_i/FCLKCLK[3]"]
set_input_jitter clk_fpga_3 0.54
#The clocks are asynchronous, user should constrain them appropriately.#
