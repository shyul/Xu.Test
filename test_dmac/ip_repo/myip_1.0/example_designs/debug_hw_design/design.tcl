...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins myip_0/csr]
	connect_bd_net [get_bd_pins myip_0/csr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_0/csr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of myip_0 streaming interfaces..
	connect_bd_net [get_bd_pins myip_0/data_i_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_0/data_i_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins myip_0/data_q_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_0/data_q_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_myip_0_csr_* ]]
	puts $fp "set csr_addr ${offset}"
