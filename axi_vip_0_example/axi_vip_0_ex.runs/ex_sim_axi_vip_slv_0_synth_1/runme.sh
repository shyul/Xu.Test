...
HD_PWD='C:/Users/uxli/Documents/Tidalloft/tungsten-grid/ip_project/axi_vip_0_example/axi_vip_0_ex.runs/ex_sim_axi_vip_slv_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_sim_axi_vip_slv_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex_sim_axi_vip_slv_0.tcl
