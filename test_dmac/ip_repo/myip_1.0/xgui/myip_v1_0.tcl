...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_csr_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_csr_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_csr_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_csr_HIGHADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_data_i_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_data_q_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.C_data_i_TDATA_WIDTH { PARAM_VALUE.C_data_i_TDATA_WIDTH } {
	# Procedure called to update C_data_i_TDATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_data_i_TDATA_WIDTH { PARAM_VALUE.C_data_i_TDATA_WIDTH } {
	# Procedure called to validate C_data_i_TDATA_WIDTH
	return true
}

proc update_PARAM_VALUE.C_data_q_TDATA_WIDTH { PARAM_VALUE.C_data_q_TDATA_WIDTH } {
	# Procedure called to update C_data_q_TDATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_data_q_TDATA_WIDTH { PARAM_VALUE.C_data_q_TDATA_WIDTH } {
	# Procedure called to validate C_data_q_TDATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_data_i_TDATA_WIDTH { MODELPARAM_VALUE.C_data_i_TDATA_WIDTH PARAM_VALUE.C_data_i_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_data_i_TDATA_WIDTH}] ${MODELPARAM_VALUE.C_data_i_TDATA_WIDTH}
}

proc update_MODELPARAM_VALUE.C_data_q_TDATA_WIDTH { MODELPARAM_VALUE.C_data_q_TDATA_WIDTH PARAM_VALUE.C_data_q_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_data_q_TDATA_WIDTH}] ${MODELPARAM_VALUE.C_data_q_TDATA_WIDTH}
}
