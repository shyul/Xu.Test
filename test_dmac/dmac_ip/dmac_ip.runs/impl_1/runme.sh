...
HD_PWD='B:/test_dmac/dmac_ip/dmac_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_dmac.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_dmac.tcl -notrace
