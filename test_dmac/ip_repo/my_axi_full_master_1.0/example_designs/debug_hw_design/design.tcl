...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock, reset & status pins of my_axi_full_master_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins my_axi_full_master_0/LITE_AXI]
	connect_bd_net [get_bd_pins my_axi_full_master_0/lite_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins my_axi_full_master_0/lite_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins my_axi_full_master_0/lite_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins my_axi_full_master_0/lite_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins my_axi_full_master_0/lite_axi_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins my_axi_full_master_0/FULL_AXI]
	connect_bd_net [get_bd_pins my_axi_full_master_0/full_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins my_axi_full_master_0/full_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins my_axi_full_master_0/full_axi_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins my_axi_full_master_0/full_axi_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins my_axi_full_master_0/full_axi_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of my_axi_full_master_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {my_axi_full_master_0/LITE_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {my_axi_full_master_0/FULL_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_LITE_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_FULL_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} ] [get_bd_cells my_axi_full_master_0]

	# Copy all address to my_axi_full_master_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/my_axi_full_master_v1_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/my_axi_full_master_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "my_axi_full_master_v1_0_hw_${i}"
